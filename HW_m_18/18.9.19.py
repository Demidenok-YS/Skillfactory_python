...
number_of_tickets = int(input("Введите количество билетов, которые Вы бы хотели преобрести: "))
...
print(f"Общая стоимость билетов: {int(total_ticket_price)} руб.")